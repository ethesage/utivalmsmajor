...
const dataAccelerator = (user, dateObj, whatsappGroup) => {
...
const dataIncubator = (user, dateObj, whatsappGroup) => {
  const html = `
    <!DOCTYPE html>
      <html lang="en">
        <head>
...
const carrerStarters = (user, dateObj, whatsappGroup) => {
  const html = `
      <!DOCTYPE html>
        <html lang="en">
          <head>
...
const designSchool = (user, dateObj, whatsappGroup) => {
  const html = `
    <!DOCTYPE html>
    <html lang="en">
        <head>
...
const projectManagement = (user, dateObj, whatsappGroup) => {
  const html = `
      <!DOCTYPE html>
      <html lang="en">
          <head>
...
const productSchool = (user, dateObj, whatsappGroup) => {
  const html = `
        <!DOCTYPE html>
        <html lang="en">
            <head>
...
const bigDataPython = (user, dateObj, whatsappGroup) => {
  const html = `
        <!DOCTYPE html>
        <html lang="en">
            <head>
