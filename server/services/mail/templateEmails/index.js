      ...
      <div>
        ...
        <ol>
          ...
          <li>
            ...
            <div>
              <h4>TUTORIALS ON EXCEL INSTALLATION</h4>
              ...
              <ol>
                ...
                <h4>Tutorials on how to install Parallels:</h4>
                <ol>
                  <li>Run Parallels on your macOS</li>
                  <li>
                  ...
                  <li>Now install Excel on your virtual Windows desktop.</li>
                  <li>
                    You can also run any other Windows app that normally will
                    not run on a Mac using Parallels
                  </li>
  ...
  const html = `
    ...
    <html lang="en">
        ...
        <div>
            ...
            <h4>It is also imperative to take note of the following:</h4>
            <ol>
            <li>The class is a <strong>100% live virtual class</strong></li>
